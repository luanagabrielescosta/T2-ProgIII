...
// void leituraVagas(list<Partido> listaPartidos, int qtdPartidos, int totalVotosLegenda, int totalCandidatos, list<Candidato> candidatosVotos,
//             list<Candidato> candidatosEleitos, int qtdVagas, list<string> infoCandidatoEleito, int qtdMulheresEleitas, int qtdHomensEleitos,
//             int totalVotosNominais, Lib library){
...
//             if(c.getSituacaoCandidato().compare("Eleito")){
...
//                 if(c.getSexoCandidato() == 'F'){
//                     qtdMulheresEleitas++; 
//                 } else if(c.getSexoCandidato() == 'M'){
//                     qtdHomensEleitos++;
//                 }   
//             } else{
